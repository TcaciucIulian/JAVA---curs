...
//        }
        ...
        try(BufferedWriter localFile = new BufferedWriter(new FileWriter("locations.txt"));
            BufferedWriter direcations = new BufferedWriter(new FileWriter("directions.txt"));
        ) {
            for(Location location : locations.values()){
                localFile.write(location.getLocationID() + "," + location.getDescription() + "\n");
                for(String direction : location.getExits().keySet()) {
                    if(!direcations.equals("Q")) {
                        direcations.write(location.getLocationID() + "," + direction +  "," + location.getExits().get(direction) + "\n");
                    }
                }
            }
        }
    ...
    static {
        ...
        try{
            ...
            while(scanner.hasNextLine()) {
                ...
                System.out.println(description + " : " + loc);
